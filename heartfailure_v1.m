...
% - we first tried to find correlation between smoking and death in which we discovered that
% people who died and did not smoke are higher in number than people who
% died and smoked.
% - secondly, we tried to find whether the amount of platelets in people
...
% - thirdly, we worked on diabetes by comparing the number of people who
